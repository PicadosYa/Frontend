...
export function Confirmation() {
    ...
    return (
        <div className="flex flex-col w-[644px] h-[486px] flex-shrink-0 rounded-[25px] p-10"
            style={{ background: "linear-gradient(to bottom, rgba(26, 57, 210, 1), rgba(13, 29, 108, 1))" }}>

            {/* Logo en la esquina superior izquierda */}
            <img src="../../../public/Logo.png" alt="Logo" className="w-1/3 h-16 mb-4" />
            ...
            <div className="flex space-x-10 mb-4 ml-6 mr-6">
                ...
                <div className="flex flex-col space-y-4">
                    <div>
                        ...
                        <input type="text" className="w-full h-8 px-2 rounded-lg border border-gray-300 shadow-sm" />
                    </div>
                    <div>
                        <label className="text-white">Cuenta de correo</label>
                        <input type="email" className="w-full h-8 px-2 rounded-lg border border-gray-300 shadow-sm" />
                    </div>
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="relative">
                        ...
                        {isTimePickerOpen && (
                            <div className="absolute z-10 w-full rounded-lg p-4"
                                style={{ background: "linear-gradient(to bottom, rgba(26, 57, 210, 1), rgba(13, 29, 108, 1))" }}
                            >
