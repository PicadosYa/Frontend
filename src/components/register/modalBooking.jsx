  ...
  return (
    <div className="futbol-card">
      ...
      <div className="futbol-card__info">
        <p>
          Bella Vista Fútbol 5, cancha techada de Fútbol 5 y hermosa barbacoa
          para cumpleaños. Contamos con un lugar integral, parrillero con
          barbacoa para 30 personas adultas, cancha techada, vestuarios con agua
          caliente, para las fiestas trabajamos con empresas de inflables,
          alquileres de piezas y calzones, tortas de cumpleaños, proyector y
          demás.
        </p>
      ...
      <div className="futbol-card__cta">
        <Button
          ...
          onClick={() => alert("Reserva solicitada")}
        />
