...
export function MyProfile() {
    return (
<div className="flex flex-col w-[600px] h-[720px] rounded-[25px] p-10" style={{ background: "linear-gradient(to bottom, rgba(26, 57, 210, 1), rgba(13, 29, 108, 1))" }}>
{/* Encabezado */}
        <div className="flex items-center justify-end ">
          <img src='./../../../public/logo-picYasvg-svg 4.png' alt="Logo" className="w-12 h-12" /> {/* Ruta de logo */}
        ...
        <div className="flex items-center mb-6 -mt-8">
          <div className="flex flex-col items-center mr-6">
            ...
            <label className="text-white">Edad</label>
              ...
              <input type="text" placeholder="Edad" className="min-w-[70px] h-10 px-4 rounded-lg border border-gray-300 shadow-sm shadow-black" />
              <button
                ...
                <img src='./../../../public/Action.png' alt="" className="pr-4"/>Cargar imagen
              </button>
              </div>
            </div>
          </div>
        ...
        <div className="flex space-x-6 mb-6">
          <div className="flex flex-col w-1/2">
            ...
            <input type="text" placeholder="Equipo" className="h-10 px-4 rounded-lg border border-gray-300 mb-6 shadow-sm shadow-black" />
              <button
                className="bg-[rgba(25,32,71,1)] text-white rounded-[25px] min-w-[148px] px-4 py-2 shadow-sm shadow-black flex flex-row justify-center items-center" >
                <img src='./../../../public/Action.png' alt="" className="pr-4"/>Cargar escudo
              </button>
          </div>
          <div className="flex flex-col w-1/2">
            <label className="text-white">Posición</label>
            <input type="text" placeholder="Posición" className="h-10 px-4 rounded-lg border border-gray-300 mb-6 shadow-sm shadow-black" />
            <button
        ...
        <div className="flex justify-between mb-4 mt-10">
          ...
          <button
            className="w-[45%] h-10 bg-orange-500 text-white rounded-[25px] shadow-sm shadow-black" style={{
              background:
