...
const Home = () => {
  ...
  return (
    ...
    <div className="w-full min-h-screen  bg-cover pt-24 pb-6 bg-center flex flex-col items-center justify-center bg-gradient-to-r from-gray-700 to-black p-4" >
      {/* Header */}
      ...
      <div className="p-4 flex flex-col gap-3">
        <div className="first-info">
          ...
          <p className="text-sm text-gray-800 overflow-hidden flex items-center gap-1" alt="description">
            <span className="font-semibold"><FaLocationDot /></span> {field.address}
          </p>
        </div>
        ...
        <div className="flex justify-between gap-1">
          ...
          <button className="bg-gray-300 rounded-[25px] px-4 py-2 text-lg font-semibold transition border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white">
            <p className="text-sm font-bold flex gap-1 items-center  bg-clip-text">
              <FaPhoneAlt />
              {field.phone}
